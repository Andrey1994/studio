...
class ENGINE_API DeviceTypeIDs
{
	public:
		...
		enum EDeviceTypeID
		{
			...
			DEVICE_TYPEID_BRAINFLOW_BASE			= 0x1000,	// 10XX = BrainFlow
			DEVICE_TYPEID_BRAINFLOW_CYTON			= 0x1001,
			DEVICE_TYPEID_BRAINFLOW_CYTON_DAISY		= 0x1002,
			DEVICE_TYPEID_BRAINFLOW_SYNTHETIC		= 0x1003,
